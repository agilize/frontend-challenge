...
export const deductsINSS = (glossSalary) => {
  switch (true) {
    case glossSalary <= 1212:
      return twoDecimals(glossSalary * 0.075);
    case glossSalary <= 2427.35:
      return twoDecimals(90.9 + (glossSalary - 1212) * 0.09);
    case glossSalary <= 3641.03:
      return twoDecimals(200.28 + (glossSalary - 2427.35) * 0.12);
    case glossSalary <= 7087.22:
      return twoDecimals(345.92 + (glossSalary - 3641.03) * 0.14);
    default:
      return 828.38;
  }
};
...
export const deductsIRRF = (glossSalary, netSalary, dependents) => {
  ...
  switch (true) {
    ...
    case glossSalary - deductsDependents <= 2826.65:
      return twoDecimals((netSalary - deductsDependents) * 0.075 - 142.8);

    case glossSalary - deductsDependents <= 3751.05:
      return twoDecimals((netSalary - deductsDependents) * 0.15 - 354.8);

    case glossSalary - deductsDependents <= 4664.68:
      return twoDecimals((netSalary - deductsDependents) * 0.225 - 636.13);

    default:
      return twoDecimals((netSalary - deductsDependents) * 0.275 - 869.36);
  }
};
